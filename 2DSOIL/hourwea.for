...
c wsun put day of year in the common block (time_public)
...
C
	  DLNGMAX = ACOS((-0.014544 - D12)/D13)*7.639437
...
C WSun to make the initial LCAI calculation to be consistent with GLYCIM
		    LCAI=LAI 
